...
import wildGuessImg from "@/assets/wildguess.jpg";
import wildQuizImg from "@/assets/wildquiz.jpg";
import wildChallImg from "@/assets/wildchall.jpg";
    ...
    <Layout>
      <div className="relative min-h-screen">
        ...
        <div className="relative z-10 p-4 space-y-6">
          ...
          <Card className="shadow-medium bg-card/95 backdrop-blur">
            <CardHeader>
              <CardTitle>Wild Quiz</CardTitle>
              <CardDescription>Test your wildlife knowledge</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-32 rounded-lg overflow-hidden mb-4">
                <img src={wildQuizImg} alt="Wild Quiz" className="w-full h-full object-cover" />
              </div>
          ...
          <Card className="shadow-medium bg-card/95 backdrop-blur">
            <CardHeader>
              <CardTitle>Wild Challenge</CardTitle>
              <CardDescription>Compete with friends in wildlife challenges</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-32 rounded-lg overflow-hidden mb-4">
                <img src={wildChallImg} alt="Wild Challenge" className="w-full h-full object-cover" />
              </div>
